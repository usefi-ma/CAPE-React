...
const ModifySpeaker = ({ speakerItem, toggleModal }) => {
  const modal = {
    position: "absolute",
    top: "50%",
    left: "50%",
  ...
  const [speskerData, setSspeskerData] = useState([]);
    ...
    //VERIFY THAT ALL INPUT FIELDS ARE FILLED IN
      ...
      try {
        ...
        const response = await axios.put(
          `http://localhost:3000/speaker/${speakerItem.Id}`,
          {
            FullName: name,
            Organization: organization,
            Image: newFile,
            ConferenceId:speakerItem.ConferenceId
          },
          config
        );

        setSspeskerData([...speskerData, response.data]);
      } catch (error) {
        console.log(error);
      }
      e.target.reset();
          ...
          <Card sx={{ padding: 3 }}>
                  <Grid sx={{ marginBottom: 3 }}
                    ...
                    <div className="executive_img_edit_wrapper me-3">
                      <img 
                        ...
                        src={`http://localhost:3000/speaker/${speakerItem.Image}`}
                      />
                    </div>
                    <Typography
                      variant="h4"
                    ...
                    >
                      Edit {speakerItem.FullName} Information
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6} md={6}>
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      name="FullName"
                      defaultValue={speakerItem.FullName}
                  ...
                  <Grid item xs={6}>
                    ...
                    <TextField
                      ...
                      name="Organization"
                      onChange={handleChange}
                      defaultValue={speakerItem.Organization}
